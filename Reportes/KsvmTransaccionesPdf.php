...
function Header()
{
  $KsvmUrlImg = '../Vistas/assets/img/medicamentos.png';
    ...
    $this->Cell(80);
    // Título
    $this->Cell(30,10,'Detalle de Transacciones',0,0,'C');
    // Salto de línea
    $this->Ln(15);
    // Arial bold 11
    $this->SetFont('Arial','B',10);

    $this->Cell(20,10,utf8_decode('#Trans'),1,0,'C');
...
function Header()
{
  $KsvmUrlImg = '../Vistas/assets/img/medicamentos.png';
    ...
    $this->Cell(80);
    // Título
    $this->Cell(30,10,'Lista de Transacciones',0,0,'C');
    // Salto de línea
    $this->Ln(15);
    // Arial bold 11
    $this->SetFont('Arial','B',10);
...
$KsvmQuery = $KsvmIniTransaccion->__KsvmImprimirTransaccionControlador();
if ($KsvmQuery->rowCount() >= 1) {
    $KsvmListaTransaccion = $KsvmQuery->fetchAll();
    // Creación del objeto de la clase heredada
$pdf = new PDF();
