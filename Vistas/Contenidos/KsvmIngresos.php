...
<section class="full-width pageContent">
	...
	<div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
		<div class="mdl-tabs__tab-bar">
			<a href="#KsvmListaIngresos" class="mdl-tabs__tab is-active">LISTA DE INGRESOS</a>
			<a href="#KsvmNuevaTransaccion" class="mdl-tabs__tab">NUEVO INGRESO</a>
		</div>
						...
						<div class="full-width panel-content">
							<form action="<?php echo KsvmServUrl; ?>Ajax/KsvmTransaccionAjax.php" method="POST"
								...
								<div class="mdl-grid">
									...
									<div
										class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop">
										<div class="mdl-textfield mdl-js-textfield">
											<select class="ksvmSelectDin" name="KsvmRqcId" id="KsvmRqcId" style="width:100%;"
												required>
										...
										class=" mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop">
												<div class="mdl-textfield mdl-js-textfield" hidden>
													<select class="ksvmSelectDin" name="KsvmTipoTran" id="KsvmTipoTran"
														style="width:100%;">
												<option value="Ingreso" selected="">Tipo de transacción</option>
													</select>
												</div>
										</div>
							...
							<form action="<?php echo KsvmServUrl; ?>Ajax/KsvmAgregarRegistrosTransaccionAjax.php"
								...
								<div class="mdl-grid" id="GridRows">
									<div
										class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop">
										<div class="mdl-textfield mdl-js-textfield" id="KsvmBodIn" hidden>
										...
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
											<input class="mdl-textfield__input" type="text" name="KsvmObservTran"
												pattern="-?[A-Za-z0-9áéíóúÁÉÍÓÚ ]*(\.[0-9]+)?" id="KsvmObservTran">
		...
		<div class="mdl-tabs__panel is-active" id="KsvmListaIngresos">
			<div class="mdl-grid">
				<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop">
					<div class="">
							...
							<div class="mdl-textfield mdl-js-textfield mdl-textfield--expandable">
								...
								<div class="mdl-textfield--expandable navBar-options-list">
									<a class="btn btn-sm btn-success mdl-shadow--8dp"
										href="<?php echo KsvmServUrl;?>Reportes/KsvmIngresosPdf.php" target="_blank"><i
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content ">
					<div class="modal-header">
						<button class="close close-edit" type="button" id="btnExitIng" data-dismiss="modal"
						...
						<form action="" method="POST" id="KsvmFormOcp">
							...
							<div class="mdl-grid">
								<div
									...
									<div class="mdl-textfield"><strong>Num.Ingreso :</strong></div>
								</div>
								<div
								...
								<div
									...
									<a class="btn btn-sm btn-primary"
										href="<?php echo KsvmServUrl;?>KsvmDetallesTransaccionEditar/<?php echo KsvmEstMaestra::__KsvmEncriptacion($KsvmLlenarForm['DtsId']);?>/1/"><i
