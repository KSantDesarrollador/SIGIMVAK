...
<?php
 ...
 ?>
	...
	<section class="full-width pageContent">
		...
		<div class="modal fade" id="KsvmDetallesBodegaXUsuario" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
			aria-hidden="true">
						...
						<div class="mdl-grid">
							<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop">
								...
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<div class="mdl-textfield__input"><strong>Bodega :</strong>&nbsp; &nbsp;<?php echo $KsvmLlenarForm['BdgDescBod'];?></div>
								</div>
							</div>
						</div>
						<br>
		...
		<script type="text/javascript"> 
		 $(document).ready(function(){
          $('#KsvmBtnExit').on('click', function () {
			  window.location.href="localhost:90/SIGIMVAK/KsvmBodegaXUsuariosCrud/1/";
		  });
							...
							<form data-form="guardar" action="<?php echo KsvmServUrl; ?>Ajax/KsvmBodegaXUsuarioAjax.php"
								...
								<p class="text-center">
									<button type="submit"
										...
										id="btn-NuevoBodegaXUsuario">
										<i class="zmdi zmdi-save">&nbsp;Guardar</i>
									</button>
								</p>
								<div class="mdl-tooltip" for="btn-NuevoBodegaXUsuario">Agregar BodegaXUsuario</div>
								<div class="RespuestaAjax"></div>
							</form>
						</div>
					</div>
