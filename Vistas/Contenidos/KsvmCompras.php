...
<section class="full-width pageContent">
	...
	<div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
		<div class="mdl-tabs__tab-bar">
			<a href="#KsvmListaCompra" class="mdl-tabs__tab is-active">LISTA DE COMPRAS</a>
			<a href="#KsvmNuevaCompra" class="mdl-tabs__tab">NUEVA COMPRA</a>
		</div>
						...
						<form data-form="" action="" method="POST" autocomplete="off" enctype="multipart/form-data">
							<div class="mdl-textfield mdl-js-textfield mdl-textfield--expandable">
								...
								<div class="mdl-textfield--expandable navBar-options-list">
									<a class="btn btn-sm btn-warning mdl-shadow--8dp"
										href="<?php echo KsvmServUrl;?>KsvmHistorialCompras/1/"><i
											class="zmdi zmdi-file">&nbsp;HISTORIAL DE COMPRAS</i></a>
							...
							<div class="mdl-grid">
								...
								<div
									...
									<a class="btn btn-sm btn-primary"
										href="<?php echo KsvmServUrl;?>KsvmDetallesCompraEditar/<?php echo KsvmEstMaestra::__KsvmEncriptacion($KsvmLlenarForm['DocId']);?>/1/"><i
