...
<section class="full-width pageContent">
	...
	<div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
		<div class="mdl-tabs__tab-bar">
			<a href="#KsvmListaAlerta" class="mdl-tabs__tab is-active">LISTA DE ALERTAS</a>
			<a href="#KsvmNuevaAlerta" class="mdl-tabs__tab">NUEVA ALERTA</a>
		</div>

		<!-- Formulario para ingresar un nuevo Alerta -->

		<div class="mdl-tabs__panel" id="KsvmNuevaAlerta">
			<div class="mdl-grid">
				<div
					...
					<div class="full-width panel mdl-shadow--8dp">
						...
						<div class="full-width panel-content">
							<form data-form="guardar" action="<?php echo KsvmServUrl; ?>Ajax/KsvmAlertaAjax.php"
								...
								<div class="mdl-tooltip" for="btnSave">Agregar Alerta</div>
					...
					<form data-form="" action="" method="POST" autocomplete="off" enctype="multipart/form-data">
						<div class="mdl-textfield mdl-js-textfield mdl-textfield--expandable">
							...
							<div class="mdl-textfield__expandable-holder">
								<input class="mdl-textfield__input" type="text" id="KsvmBuscarAle" name="KsvmBuscarAle">
								<label class="mdl-textfield__label"></label>
							</div>
							<div class="mdl-textfield--expandable navBar-options-list">
								<a class="btn btn-sm btn-success mdl-shadow--8dp"
									href="<?php echo KsvmServUrl;?>Reportes/KsvmAlertasPdf.php" target="_blank"><i
								...
								<div
									...
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<div class="mdl-textfield__input"><strong>Color :</strong>&nbsp; &nbsp;<button
												class="btn btn-md"
												style="border-color:#000; background-color:<?php echo $KsvmLlenarForm['AltColorAle'];?>;"></button>
										</div>
									</div>
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<div class="mdl-textfield__input"><strong>Descripción :</strong>&nbsp;
											&nbsp;<?php echo $KsvmLlenarForm['AltDescAle'];?></div>
									</div>
								</div>
							</div>
							<br>
