            ...
            <br>
             <div class="full-width panel mdl-shadow--8dp">
                 ...
                 <div class="full-width panel-content">
                     <form data-form="guardar" action="<?php echo KsvmServUrl; ?>Ajax/KsvmProcedenciaAjax.php" method="POST"
                         class="FormularioAjax" autocomplete="off" enctype="multipart/form-data" id="KsvmFormProcedencia">
                         ...
                         <div class="mdl-grid">
									<div
                                        ...
                                        <select class="mdl-textfield__input" name="KsvmNivProc"> 
                                        <option value="<?php echo $KsvmLlenarForm['PrcNivProc'];?>"><?php echo $KsvmNivel;?></option>
										...
										<div class="mdl-textfield mdl-js-textfield">
											<select class="mdl-textfield__input" name="KsvmJerqMen">
												<option value="<?php echo $KsvmLlenarForm['PrcJerqProc'];?>" selected=""><?php echo $KsvmNomJerq;?></option>
                                        ...
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
											<input class="mdl-textfield__input" type="text" name="KsvmCodProc"
                                                value="<?php echo $KsvmLlenarForm['PrcCodProc']?>" id="KsvmCodProc">
                                        ...
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
											<input class="mdl-textfield__input" type="text" name="KsvmDescProc"
                                                value="<?php echo $KsvmLlenarForm['PrcDescProc']?>" id="KsvmDescProc">
                         ...
                         <p class="text-center">
                             <button type="submit"
                                 ...
                                 id="btn-ActualizarProcedencia">
                                 <i class="zmdi zmdi-save">&nbsp;Guardar</i>
                             </button>
                         </p>
                         <div class="mdl-tooltip" for="btn-ActualizarProcedencia">Actualizar Procedencia</div>
