	...
	<div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
							...
							<form data-form="guardar" action="<?php echo KsvmServUrl; ?>Ajax/KsvmEmpleadoAjax.php"
								...
								<div class="mdl-grid">
									<div
										...
										<div class="mdl-textfield mdl-js-textfield">
											<select class="ksvmSelectDin" name="KsvmTipoIdent" id="KsvmDato1"
												style="width:100%;">
										...
										<div class="">
											<input class="" type="file" accept="image/*" name="KsvmFotoEmp" id="KsvmFotoEmp">
									...
									<div
										class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop">
										<div class="mdl-textfield mdl-js-textfield">
											<select class="ksvmSelectDin" style="width:100%;"
												id="KsvmCargaListaProvincia">
										...
										<div class="mdl-textfield mdl-js-textfield">
											<select class="ksvmSelectDin" name="KsvmRol" id="KsvmDato8"
												style="width:100%;">
										...
										<div class="mdl-textfield mdl-js-textfield">
											<select class="ksvmSelectDin" name="KsvmCargo" id="KsvmDato9"
												style="width:100%;">
										...
										<div class="mdl-textfield mdl-js-textfield">
											<select class="ksvmSelectDin" name="KsvmEstCiv" id="KsvmDato13"
												style="width:100%;">
										...
										<div class="mdl-textfield mdl-js-textfield">
											<select class="ksvmSelectDin" name="KsvmSexo" id="KsvmDato14"
												style="width:100%;">
										...
										<div class="mdl-textfield mdl-js-textfield">
											<select class="ksvmSelectDin" name="KsvmGenero" id="KsvmDato15"
												style="width:100%;">
							...
							<div class="mdl-textfield mdl-js-textfield mdl-textfield--expandable">
								...
								<div class="mdl-textfield--expandable navBar-options-list">
									<a class="btn btn-sm btn-success mdl-shadow--8dp"
										href="<?php echo KsvmServUrl;?>Reportes/KsvmEmpleadosPdf.php" target="_blank"><i
		...
		<?php 
		  ...
		  if ($KsvmDataEdit->rowCount() == 1) {
			...
			$KsvmEdad = $KsvmIniEmp-> __KsvmCalculaEdad($KsvmLlenarForm['EpoFchNacEmp']);
