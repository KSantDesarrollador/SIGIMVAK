	...
	<div class="container-login full-width">
		...
		<form action="" autocomplete="off" method="POST">
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				<input class="mdl-textfield__input" type="text" id="KsvmDato1" name="KsvmUsuario" pattern="^([A-Z]+[0-9]{0,3}){5,12}$">
				<label class="mdl-textfield__label" for="KsvmDato1">Usuario</label>
				<span class="mdl-textfield__error">Usuario Inválido</span>
				<span id="KsvmError1" class="ValForm"><i class="zmdi zmdi-alert-triangle">&nbsp;Este campo es necesario</i></span>
			</div>
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
				<input class="mdl-textfield__input" type="password" id="KsvmDato2" name="KsvmContra" pattern="[A-Za-z0-9!?-]{8,16}">
				<label class="mdl-textfield__label" for="KsvmDato2">Contraseña</label>
				<span class="mdl-textfield__error">Contraseña Inválida</span>
				<span id="KsvmError2" class="ValForm"><i class="zmdi zmdi-alert-triangle">&nbsp;Este campo es necesario</i></span>
			</div>
			<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
