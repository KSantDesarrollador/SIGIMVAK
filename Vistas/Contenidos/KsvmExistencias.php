								...
								<form data-form="guardar"
									...
									<div class="mdl-grid">
										...
										<div
											...
											<!-- <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label"
												id="KsvmStockEx">
												<input class="mdl-textfield__input" type="number" name="KsvmStockEx"
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content ">
						<div class="modal-header">
							<button class="close close-edit" type="button" data-dismiss="modal" id="btnExitExt"
										...
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
											<div class="mdl-textfield__input"><strong>Código de Barras :</strong>
												...
												<a href="<?php echo KsvmServUrl;?>Reportes/KsvmCodBarPdf.php?Cod=<?php echo KsvmEstMaestra::__KsvmEncriptacion($KsvmLlenarForm['ExtId'])?>"
													...
													style="float:right;"><i class="zmdi zmdi-print">&nbsp;
														&nbsp;IMPRIMIR</i></a></div>
										</div>
									</div>
								</div>
