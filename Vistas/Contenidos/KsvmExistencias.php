									...
									<div
										...
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
											<div class="mdl-textfield__input"><strong>Código de Barras :</strong>
												&nbsp; &nbsp;<img
													src="<?php echo KsvmServUrl;?>Vistas/Contenidos/barcode.php?text=<?php echo $KsvmLlenarForm['ExtCodBarEx'];?>&size=30&orientation=horizontal&codetype=codabar&print=true&sizefactor=2" />
												<a href="#" class="btn btn-xs btn-success" style="float:right;"><i
														class="zmdi zmdi-print">&nbsp; &nbsp;IMPRIMIR</i></a></div>
										</div>
									</div>
								</div>
								<div class="RespuestaAjax"></div>
