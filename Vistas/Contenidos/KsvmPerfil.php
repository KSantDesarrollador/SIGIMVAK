                 ...
                 <div class="full-width panel-content">
                     <form data-form="guardar" action="<?php echo KsvmServUrl; ?>Ajax/KsvmUsuarioAjax.php" method="POST"
                         ...
                         <div class="mdl-grid">
                             ...
                             <div class="">
                                <label class="mdl-textfield"><img style="border-radius:7px;" height="250px" width="70%" src="data:image/jpg;base64,<?php echo base64_encode($KsvmLlenarForm['UsrImgUsu']);?>"/>&nbsp;</label>
                            </div>
                            </div>
