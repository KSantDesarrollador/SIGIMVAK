						...
						<form data-form="" action="" method="POST" autocomplete="off" enctype="multipart/form-data">
							<div class="mdl-textfield mdl-js-textfield mdl-textfield--expandable">
								...
								<div class="mdl-textfield__expandable-holder">
									<input class="mdl-textfield__input" type="text" id="KsvmBuscarCat"
										name="KsvmBuscarCat">
						...
						<div class="mdl-grid">
							<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop">
								<div class="mdl-textfield mdl-js-textfield">
									<div class="mdl-textfield__input"><strong>Nombre :</strong>&nbsp; &nbsp;<?php echo $KsvmLlenarForm['CtgNomCat'];?></div>
								</div>
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<div class="mdl-textfield__input"><strong>Color :</strong>&nbsp; &nbsp;<button class="btn btn-md" style="border-color:#000; background-color:<?php echo $KsvmLlenarForm['CtgColorCat'];?>;"></button></div>
								</div>
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
		...
		<script type="text/javascript"> 
		 $(document).ready(function(){
          $('#KsvmBtnExit').on('click', function () {
			  window.location.href="localhost:90/SIGIMVAK/KsvmCategoriasCrud/1/";
		  });
							...
							<form data-form="guardar" action="<?php echo KsvmServUrl; ?>Ajax/KsvmCategoriaAjax.php"
								...
								<div class="mdl-grid">
									<div
										...
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
											...
											pattern="-?[A-Za-záéíóúÁÉÍÓÚñ ]*(\.[0-9]+)?" id="KsvmNomCat">
											<label class="mdl-textfield__label" for="KsvmNomCat">Nombre</label>
											<span class="mdl-textfield__error">Nombre Inválido</span>
										</div>
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
											<input class="mdl-textfield__input" type="color" name="KsvmColorCat"
												id="KsvmColorCat">
											<label class="mdl-textfield__label" for="KsvmColorCat">Color</label>
								...
								<p class="text-center">
									<button type="submit"
										...
										id="btn-NuevaCategoria">
										<i class="zmdi zmdi-save">&nbsp;Guardar</i>
									</button>
								</p>
								<div class="mdl-tooltip" for="btn-NuevaCategoria">Agregar Categoría</div>
								<div class="RespuestaAjax"></div>
							</form>
						</div>
					</div>
