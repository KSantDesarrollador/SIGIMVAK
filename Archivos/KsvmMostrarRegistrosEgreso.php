...
class KsvmMostrarRegistrosEgreso extends KsvmEstMaestra
{

    public function __KsvmMostrarRegistros()
    {

    $KsvmMuestraRegistro = "SELECT * FROM ksvmvistaregistrostransaccion WHERE DtsEstTran = 'N' AND DtsTipoTran = 'Egreso'";
...
<script type="text/javascript">
   $(document).ready(function(){
    ...
    function KsvmCargarData() {
        $.ajax({
		type: 'POST',
        url: '<?php echo KsvmServUrl;?>Ajax/KsvmMostrarRegistrosEgresosAjax.php'
        })
